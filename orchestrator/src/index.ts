...
// NOTE: Rate limiter temporarily disabled to diagnose startup hang.
// Suspected cause: getRedis() connection timing out during plugin registration.
// Re-enable once Redis connectivity is confirmed healthy.
