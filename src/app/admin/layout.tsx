...
import { Squares2X2Icon, UsersIcon, CpuChipIcon, ArrowUturnLeftIcon, EnvelopeIcon, ChartBarIcon, GiftIcon, CreditCardIcon, SignalIcon, BuildingStorefrontIcon, ExclamationTriangleIcon, BanknotesIcon, ArrowTrendingUpIcon, PaperAirplaneIcon } from "@heroicons/react/24/outline"
...
const navItems = [
  ...
  { href: "/admin/events", label: "Events", icon: <ExclamationTriangleIcon width={16} height={16} /> },
  ...
  { href: "/admin/finances", label: "Finances", icon: <BanknotesIcon width={16} height={16} /> },
  { href: "/admin/revenue", label: "Revenue", icon: <ArrowTrendingUpIcon width={16} height={16} /> },
  { href: "/admin/newsletter", label: "Newsletter", icon: <EnvelopeIcon width={16} height={16} /> },
  { href: "/admin/outreach", label: "Outreach", icon: <PaperAirplaneIcon width={16} height={16} /> },
]
