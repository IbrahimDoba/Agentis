  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await signIn("credentials", {
        ...
        // Pass the current host so the server can resolve which reseller tenant
        // this login belongs to (the same email can exist on multiple tenants).
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        <p className={styles.subtitle}>Sign in to your {brand.appName} account</p>
        ...
        {brand.isPlatform && (
          <>
            <button
              ...
              onClick={() => signIn("google", { callbackUrl: "/dashboard/start" })}
            >
